...
RISCV_PATH := /home/brian/Downloads/gnu-mcu-eclipse-riscv-none-gcc-8.2.0-2.2-20190521-0004-centos64/gnu-mcu-eclipse/riscv-none-gcc/8.2.0-2.2-20190521-0004
...
CLEAN_OBJS += $(TARGET) $(LINK_OBJS) $(TARGET).dump $(TARGET).bin $(TARGET).hex $(TARGET)_v.hex $(TARGET).data
...
$(TARGET): $(LINK_OBJS) $(LINK_DEPS) Makefile
	...
	$(RISCV_OBJCOPY) -O verilog $@ $@_v.hex
	$(RISCV_OBJCOPY) -O ihex $@ $@.hex
